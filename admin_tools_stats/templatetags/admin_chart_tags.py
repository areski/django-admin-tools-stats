...
def set_nvd3_css_path(val=None):
    return static_or_path(
        getattr(settings, 'ADMIN_CHARTS_NVD3_CSS_PATH', 'https://unpkg.com/nvd3@1.8.6/build/nv.d3.min.css'),
    )
...
def set_nvd3_js_path(val=None):
    return static_or_path(
        getattr(settings, 'ADMIN_CHARTS_NVD3_JS_PATH', 'https://unpkg.com/nvd3@1.8.6/build/nv.d3.min.js'),
    )
